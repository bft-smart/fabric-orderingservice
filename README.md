...
This is proof-of-concept for a Byzantine fault-tolerant (BFT) ordering service for Hyperledger Fabric (HLF) v1.0. This BFT ordering service is a wrapper around BFT-SMaRt (https://github.com/bft-smart/library), a Java open source BFT library maintained by the LaSIGE research unit at the University of Lisbon.
